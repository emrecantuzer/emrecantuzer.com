        ...
        >
            <div className="max-w-7xl mx-auto px-4 md:px-10 flex justify-between items-center">
                <Link href="#" className="flex items-center gap-2 text-xl font-bold tracking-tighter">
                    ...
                    <span>Emre<span className="text-primary">.</span></span>
                </Link>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full left-0 w-full bg-slate-900/95 backdrop-blur-md border-b border-white/10 overflow-hidden md:hidden"
                    >
