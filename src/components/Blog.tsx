...
export default function Blog() {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            try {
                ...
                // Fetch from API
                const rssUrl = process.env.NEXT_PUBLIC_MEDIUM_RSS_URL || "https://medium.com/feed/@emrecantzer";
    ...
    return (
        <section id="blog" className="py-20 px-4 md:px-10 relative">
            {/* Background Glow */}
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <Link
                        href={process.env.NEXT_PUBLIC_MEDIUM_URL || "https://medium.com/@emrecantzer"}
                        target="_blank"
    ...
    return (
        ...
        >
            <Link href={post.link} target="_blank" rel="noopener noreferrer" className="flex-1 flex flex-col">
                <div className="relative h-48 w-full rounded-2xl overflow-hidden mb-4 border border-white/10 group-hover:border-primary/50 group-hover:shadow-xl group-hover:shadow-primary/20 transition-all">
                    {post.thumbnail ? (
                        <Image
                            src={post.thumbnail}
                            alt={post.title}
